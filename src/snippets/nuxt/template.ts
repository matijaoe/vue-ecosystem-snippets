...
export const template: XSnippetDefinition = {
  ...
  snippets: {
    ...
    "nlink:_blank": {
      ...
      body: '<NuxtLink to="$1" target="_blank">$3</NuxtLink>',
    },
    "nlink:param": {
      name: "NuxtLink with param",
      body: '<NuxtLink :to="`$1${${2:id}}$3`">$5</NuxtLink>',
    },
    "nlink:obj": {
    ...
    "nlink:name": {
      ...
      body: `<NuxtLink :to="{ name: '$1'$2 }">$4</NuxtLink>`,
    },
    "nlink:path": {
      name: "NuxtLink with path",
      body: `<NuxtLink :to="{ path: '$1'$2 }">$4</NuxtLink>`,
    },
    "nloading": {
